...
//				 3/9/17		- One method intentionally broken
//				10/7/18		- Broken method(s) changed
//							  Delete method modified to have parameter
//				 
//Project List 
//
...
const float CONTRACTION_FACTOR = 0.50f;				//Used to contract list
const float OCCUPANCY_TRIGGER = 0.33f;				//Used to determine if contraction is needed
...
public: 
	...
	virtual void Delete(/* in */KeyType target); 
		//deletes list entry of target, 
